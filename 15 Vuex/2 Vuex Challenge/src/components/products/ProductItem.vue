...
<style scoped>
  ...
  .product__data { display: flex; }
  .product__image { margin-right: 1rem; }
  ...
  .product__text h3 { margin: 0 0 0.5rem 0; }
  .product__text h4 { margin: 0; }
  .product__actions { text-align: center; }
